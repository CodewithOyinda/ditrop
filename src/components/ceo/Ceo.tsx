  ...
  return (
    <div className="bg-[#F5F8FF] py-20 px-5 sm:px-10 lg:px-20">
        <div className="flex flex-col justify-center lg:flex-row items-center lg:items-start gap-10 max-w-7xl mx-auto">
          <div>
            <img src={ceo} alt="ceo" className="rounded-[20px] w-[200px] sm:w-[500px] "/>
          ...
          <p className="text-[#0a54ff] sm:text-[14px] text-[10px] font-[600] mt-6">It started with a simple need: the need for life to be easier.</p>
          <p className="w-[500px] sm:text-[16px] text-[12px] mt-6 leading-[2]">When Cole Samuel moved to a new city, everyday challenges quickly became clear, reliable transportation was rare, finding a good home felt overwhelming, and accessing basic services took more effort than it should. Simple things that should have made life flow smoothly were suddenly complicated.</p>
          </div>
          <div>
             <p className="w-[500px] sm:text-[16px] text-[12px]">Rather than accept these struggles as the norm, he saw an opportunity  to create a different kind of platform. One where living, moving, and earning would be more connected, more accessible, and far less complicated for everyone, not just a few.</p>
             <p className="w-[500px] sm:text-[16px] text-[12px] mt-7">What began as a series of personal frustrations quickly turned into the blueprint for something bigger. It became a bold idea: what if there was a single place people could trust for the essentials that keep life moving? </p>
             <p className="w-[500px] sm:text-[16px] text-[12px] mt-7">On November 13, 2023, that idea became Ditrop Inc.</p>
             <p className="w-[500px] sm:text-[16px] text-[12px] mt-7">A space where solutions are created with people in mind. Where the focus isn’t just on technology but on real, practical change that makes everyday life better.</p>
             <p className="w-[500px] sm:text-[16px] text-[12px] mt-7">Today, Ditrop stands as proof that challenges can spark innovation and that small, personal experiences can grow into something powerful enough to impact lives across cities, communities, and borders.</p>
          </div>
        </div>
        <div className="mt-40">
            <p className="sm:text-[20px] text-[16px] font-[600]  mb-3 mx-5">MEET DITROP</p>
            <p className="sm:text-[22px] text-[18px] font-[700] mb-8 mx-5">Who We Are & What We Do</p>
            <div className="flex flex-col justify-center lg:flex-row items-center lg:items-start gap-10 max-w-7xl mx-auto">
               <div className="w-[500px] sm:text-[16px] text-[12px]">
